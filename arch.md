 ...
 * If OP is 0x01, then set AC to AC + F[Y].
   The assembler mnemonic is FADD.
 
 * If OP is 0x02, then set AC to AC - F[Y].
   The assembler mnemonic is FSUB.
 
 * If OP is 0x03, then set AC to AC / F[Y].
   The assembler mnemonic is FDIV.
 
 * If OP is 0x04, then set AC to AC * F[Y].
   The assembler mnemonic is FMUL.
 
 * If OP is 0x05, then set F[Y] to AC + F[Y].
   The assembler mnemonic is FADDM.
  
 * If OP is 0x07, then set F[Y] to AC * F[Y].
 ...
 * If OP is 0x12, then set FPC to Y.
